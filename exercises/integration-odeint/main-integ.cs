//In this class the integrate class is used to calculate the integral of ln(x)/sqrt(x) from 0 to 1. Furthermore
//the integral class is used to implement the error function using its integral representation.
using System;
